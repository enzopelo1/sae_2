...
image_astronomique = cv2.imread('fichiers ressource-20231023/lumiere.jpg')
...
image_astronomique[non_pollution_mask > 0] = image_astronomique[non_pollution_mask > 0] * 0.2
